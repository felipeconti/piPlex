...
$sh_c "apt-get -y --no-install-recommends install apt-transport-https ca-certificates curl wget htop vim -qq >/dev/null"
set +x
...
output "Plex: 8080"
output "Transmission: 8081 (web) and 51413 (peer)"
output ""
